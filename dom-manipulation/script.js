...
let quotes = [
  ...
  function populateCategories() {
    ...
    categoryFilter.innerHTML = ''; // Clear all categories
    ...
    categories.forEach(category => {
      ...
      option.textContent = category;  // Using textContent instead of innerHTML
  ...
  function showRandomQuote() {
    ...
    quoteDisplayDiv.textContent = `${randomQuote.text} - ${randomQuote.category}`;  // Using textContent instead of innerHTML
  ...
  function filterQuotes() {
    ...
    if (filteredQuotes.length > 0) {
      ...
      quoteDisplayDiv.textContent = 'No quotes available in this category.';  // Using textContent instead of innerHTML
    }
  }
  ...
  function createAddQuoteForm() {
    ...
    addButton.textContent = 'Add Quote';  // Using textContent to set button text
  ...
  function restoreLastQuote() {
    ...
    if (lastQuote) {
      ...
      const quoteDisplayDiv = document.getElementById('quoteDisplay');
      quoteDisplayDiv.textContent = `${parsedQuote.text} - ${parsedQuote.category}`;  // Using textContent instead of innerHTML
    }
  }
